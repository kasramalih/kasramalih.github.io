<div class="about-header">
  <img src="assets/profile.jpg" alt="Portrait of Kasra" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi I'm Kasra!</h1>
  ...
  <a href="https://github.com/kasramalih" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <!-- <a href="https://www.linkedin.com/in/kasramalihi/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:kasramalihi@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I am a first-year **MSc student specializing in Machine Learning and Language Technologies at the University of Copenhagen**. In the upcoming academic year, I will join **ETH Zurich** as an exchange student.

My current research spans theoretical machine learning and natural language processing. Currently, I work with Prof. Amartya Sanyal on certified machine learning, and with Prof. Desmond Elliott on PIXEL language models.

Broadly, my objective is to develop models that maximize the utility of available data through post-training paradigms, rather than relying on data scaling during pre-training. I am particularly interested in addressing current reasoning bottlenecks through reinforcement learning and the development of better reward modeling techniques.

Prior to Copenhagen, I received my **BSc in Computer Engineering from Sharif University of Technology**, where I ranked **6th internationally** in university entrance exam. Outside of my academic work, I enjoy reading mathematical finance due to my interest in math esp. derivatives, play chess, and go to the gym.